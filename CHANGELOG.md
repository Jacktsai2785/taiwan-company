...
- Call Memo 各欄位若包含多個重點（人員、產品、技術、財務數字、投資條件等），AI 統整時改用條列（一項一行）呈現，取代擠成一大段連續文字，提升閱讀性
## [1.4.0] - 2026-09-23

### Added

- Call Memo 新增財務預測表格（年度 x Now/Now+1/Now+2/Now+3，16 項會計科目），支援收合、AI 依補充資料自動填值、實際財報期間標籤

### Fixed

- 修正 Call Memo 上傳 PDF 若含設計排版頁面，AI 讀圖時把人名/學校等專有名詞誤認成其他字的幻覺問題；改成直接讀取原始內嵌圖片，不再讓 CLI 自行轉檔
## [1.3.4] - 2026-09-23

### Fixed

- 修正補充資料上傳 PDF 若含設計排版頁面（如封面、經營團隊介紹），Call Memo AI 抽取會漏掉圖片頁內容、只填得出財務資訊的問題
## [1.3.3] - 2026-09-23

### Fixed

- 修正補充資料上傳成功後，上傳按鈕文字被擠壓成逐字直排的版面錯亂
## [1.3.2] - 2026-09-23

### Fixed

- 補上公司官網快速搜尋的聚合器黑名單（findit.sme.gov.tw、alltwcompany.com），避免政府新創資料庫頁面被誤判為官網
## [1.3.1] - 2026-09-18
